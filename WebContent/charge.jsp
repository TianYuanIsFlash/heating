...
<form class="form-horizontal" role="form" id="myposition" action="payAction">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">
         <input class="form-control" id="money" type="text" 
             style="width:15%;" name="money">

        <button type="button" id="subBtn" class="btn btn-default">缴费</button>
   </div>
 ...
 <span style="color: blue;">缴费信息状态：</span><u><b><span id="show" style="color: blue;"></span></b></u>
