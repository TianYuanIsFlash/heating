...
<form class="form-horizontal" role="form" id="myposition" action="payAction">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">
         ...
         <button type="button" id="subBtn" class="btn btn-default">退费</button>
      </div>
   </div>
 ...
 <span style="color: blue;">退费信息状态：</span><u><b><span id="show" style="color: blue;"></span></b></u>
