...
<hr>
<a href="empManager.action"><button type="button" class="btn btn-primary" id="noWorkBtn">空闲查看</button></a>
   ...
   <tbody>
      ...
      <td colspan="10">
       <ul class="pagination">
		  ...
		  <li><a href="empManager.action?num=last">&laquo;</a></li>
		  <li><a href="empManager.action?result=1">1</a></li>
		  <li><a href="empManager.action?result=2">2</a></li>
		  <li><a href="empManager.action?result=3">3</a></li>
		  <li><a href="empManager.action?result=4">4</a></li>
		  <li><a href="empManager.action?result=5">5</a></li>
		  <li><a href="empManager.action?num=end">...${mapPage.totalPage}</a></li>
		  <li><a href="empManager.action?num=next">&raquo;</a></li>
		  
		  <li><form action="empManager" method="post">
