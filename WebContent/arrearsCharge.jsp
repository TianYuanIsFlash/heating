...
<table class="table table-hover">
   ...
   <tr>      
         ...
         <a href="costAllAction.action"><input type="button" class="btn btn-default" value="全部用户"></a>
         <a href="excelChargeArrearsAction.action"><input type="button" class="btn btn-default" value="导出"></a>
         <input type="button" class="btn btn-default" value="每页显示数量">
         
         
         <form action="costAllBTNAction" role="form" style="display: inline-block;position:relative;top: 30px;" id="formSub">
    ...
    <c:forEach var="u" items="${requestScope.list}">
      ...
      <td colspan="10">
       <ul class="pagination">
		  ...
		  <li><a href="costAllBTNAction.action?num=last">&laquo;</a></li>
		  <li><a href="costAllBTNAction.action?result=1">1</a></li>
		  <li><a href="costAllBTNAction.action?result=2">2</a></li>
		  <li><a href="costAllBTNAction.action?result=3">3</a></li>
		  <li><a href="costAllBTNAction.action?result=4">4</a></li>
		  <li><a href="costAllBTNAction.action?result=5">5</a></li>
		  <li><a href="costAllBTNAction.action?num=end">...${mapPage.totalPage}</a></li>
		  <li><a href="costAllBTNAction.action?num=next">&raquo;</a></li>
		  
		  <li><form action="costAllBTNAction" method="post">
